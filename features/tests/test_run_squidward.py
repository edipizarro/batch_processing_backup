...
from ..evaluate_squidward_model import evaluate_squidward_many_files


script_path = os.path.dirname(os.path.abspath(__file__))


class TestDistributedSquidward(unittest.TestCase):
    def setUp(self):
        self.output_directory = "/tmp/test_distributed_squidward"
