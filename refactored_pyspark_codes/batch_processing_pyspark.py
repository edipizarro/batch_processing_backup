...
df_sorting_hat = sorting_hat.run_sorting_hat_step('parquet_test', spark)
...
#print('magstats size is ', magstats_stats.count())
#print('objstats size is ', object_stats.count())
...
xmatch_step_result = xmatch_step_result.withColumnRenamed('angDist', 'dist')\
