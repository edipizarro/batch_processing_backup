...
def main(corrected_dir, non_det_dir, output_dir, partition, node_id, job_id, logs_dir, version):
    """
    ...
    non_det = pd.read_parquet(os.path.join(non_det_dir, non_det_file), columns=["objectId", "jd", "isdiffpos", "fid", "diffmaglim"])
